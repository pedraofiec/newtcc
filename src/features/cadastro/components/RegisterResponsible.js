...
const RegisterResponsible = () => {
  ...
  const handleSubmit = async (event) => {
    ...
    const data = { nomeResponsavel, cpfResponsavel, enderecoCasa, email, password };
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-b from-[#4DD0E1] from-0% to-white-500 to-50% p-4 relative overflow-hidden">
      <div className="flex flex-col items-center justify-center p-8 bg-white rounded-2xl shadow-2xl mt-16 form-container is-visible relative">
        ...
        <h2 className="text-2xl font-semibold mb-6 text-gray-800 mt-6">CADASTRO DE RESPONSÁVEL</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-3 w-full">
          <input type="text" placeholder="Nome Completo" value={nomeResponsavel} onChange={(e) => setNomeResponsavel(e.target.value)} className="w-full p-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200 bg-gray-200 placeholder-gray-500" required />
          <input type="text" placeholder="CPF" value={cpfResponsavel} onChange={(e) => setCpfResponsavel(e.target.value)} className="w-full p-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200 bg-gray-200 placeholder-gray-500" required />
          <input type="text" placeholder="Endereço Completo" value={enderecoCasa} onChange={(e) => setEnderecoCasa(e.target.value)} className="w-full p-3 rounded-md border border-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none transition duration-200 bg-gray-200 placeholder-gray-500" required />
